// https://registry.terraform.io/providers/grafana/grafana/3.15.3/docs/data-sources/cloud_provider_aws_cloudwatch_scrape_job
...
export interface DataGrafanaCloudProviderAwsCloudwatchScrapeJobConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/3.15.3/docs/data-sources/cloud_provider_aws_cloudwatch_scrape_job#name DataGrafanaCloudProviderAwsCloudwatchScrapeJob#name}
  */
  readonly name: string;
  /**
  * The Stack ID of the Grafana Cloud instance. Part of the Terraform Resource ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/3.15.3/docs/data-sources/cloud_provider_aws_cloudwatch_scrape_job#stack_id DataGrafanaCloudProviderAwsCloudwatchScrapeJob#stack_id}
  */
  readonly stackId: string;
  /**
  * custom_namespace block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/3.15.3/docs/data-sources/cloud_provider_aws_cloudwatch_scrape_job#custom_namespace DataGrafanaCloudProviderAwsCloudwatchScrapeJob#custom_namespace}
  */
  readonly customNamespace?: DataGrafanaCloudProviderAwsCloudwatchScrapeJobCustomNamespace[] | cdktf.IResolvable;
  /**
  * service block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/3.15.3/docs/data-sources/cloud_provider_aws_cloudwatch_scrape_job#service DataGrafanaCloudProviderAwsCloudwatchScrapeJob#service}
  */
...
export interface DataGrafanaCloudProviderAwsCloudwatchScrapeJobCustomNamespace {
  ...
  * metric block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/3.15.3/docs/data-sources/cloud_provider_aws_cloudwatch_scrape_job#metric DataGrafanaCloudProviderAwsCloudwatchScrapeJob#metric}
  */
...
export interface DataGrafanaCloudProviderAwsCloudwatchScrapeJobService {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/3.15.3/docs/data-sources/cloud_provider_aws_cloudwatch_scrape_job#resource_discovery_tag_filter DataGrafanaCloudProviderAwsCloudwatchScrapeJob#resource_discovery_tag_filter}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/3.15.3/docs/data-sources/cloud_provider_aws_cloudwatch_scrape_job grafana_cloud_provider_aws_cloudwatch_scrape_job}
*/
export class DataGrafanaCloudProviderAwsCloudwatchScrapeJob extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaCloudProviderAwsCloudwatchScrapeJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/3.15.3/docs/data-sources/cloud_provider_aws_cloudwatch_scrape_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/3.15.3/docs/data-sources/cloud_provider_aws_cloudwatch_scrape_job grafana_cloud_provider_aws_cloudwatch_scrape_job} Data Source
  *
  * @param scope The scope in which to define this construct

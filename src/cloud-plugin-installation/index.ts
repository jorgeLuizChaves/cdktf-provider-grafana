// https://registry.terraform.io/providers/grafana/grafana/3.15.3/docs/resources/cloud_plugin_installation
...
export interface CloudPluginInstallationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/3.15.3/docs/resources/cloud_plugin_installation#id CloudPluginInstallation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/3.15.3/docs/resources/cloud_plugin_installation#slug CloudPluginInstallation#slug}
  */
  readonly slug: string;
  /**
  * The stack id to which the plugin should be installed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/3.15.3/docs/resources/cloud_plugin_installation#stack_slug CloudPluginInstallation#stack_slug}
  */
  readonly stackSlug: string;
  /**
  * Version of the plugin to be installed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/3.15.3/docs/resources/cloud_plugin_installation#version CloudPluginInstallation#version}
  */
  readonly version: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/3.15.3/docs/resources/cloud_plugin_installation grafana_cloud_plugin_installation}
*/
export class CloudPluginInstallation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudPluginInstallation that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/3.15.3/docs/resources/cloud_plugin_installation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/3.15.3/docs/resources/cloud_plugin_installation grafana_cloud_plugin_installation} Resource
  *
  * @param scope The scope in which to define this construct
